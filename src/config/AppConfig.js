...
export const AppConfig = {
  // API Configuration
  api: {
    baseUrl: '/intranet2/api/songs', // Ruta relativa para producción
    timeout: 10000,
    retryAttempts: 3,
    retryDelay: 1000
  },
  ...
  googleCalendar: {
    apiKey: '',        // Si está vacío, no se activa el plugin
    calendarId: '',
    locale: 'es'
  },
  ...
  admin: {
    // HASH SHA-256 de la contraseña (cámbiala).
  ...
  return {
    ...
    api: {
      ...
      baseUrl: isDevelopment 
        ...
        : '/intranet2/api/songs',                   // Producción (afsalineros.es)
  ...
  switch (hostname) {
    ...
    case '127.0.0.1':
      return {
        ...
        api: { baseUrl: 'http://localhost/intranet2/api/songs' },
    ...
    case 'staging.afsalineros.es': // Si tienes un entorno de staging
      return {
        name: 'Staging',
        api: { baseUrl: '/intranet2/api/songs', debug: true },
    ...
    case 'www.afsalineros.es':
      return {
        name: 'Producción',
        api: { baseUrl: '/intranet2/api/songs', debug: false },
